...
interface Lista {
    ...
    void inserir(Object item, int pos) throws PosicaoInvalidaException;

    Object remover() throws ListaVaziaException;
    Object remover(int pos) throws PosicaoInvalidaException, ListaVaziaException;
...
class ListaArray implements Lista {
    ...
    public void inserir(Object item, int pos) throws PosicaoInvalidaException {
        if(pos > tamanho())
    ...
    public Object remover() throws ListaVaziaException {
    ...
    public Object remover(int pos) throws ListaVaziaException, PosicaoInvalidaException{
